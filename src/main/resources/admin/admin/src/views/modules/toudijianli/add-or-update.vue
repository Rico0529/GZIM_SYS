<template>
	<div class="addEdit-block">
		...
		>
			<template >
				<el-form-item class="input" v-if="type!='info'"  label="招聘名称" prop="zhaopinmingcheng" >
					<el-input v-model="ruleForm.zhaopinmingcheng" placeholder="招聘名称" clearable  :readonly="ro.zhaopinmingcheng"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="招聘名称" prop="zhaopinmingcheng" >
				...
				<el-form-item class="input" v-if="type!='info'"  label="技能要求" prop="jinengyaoqiu" >
					<el-input v-model="ruleForm.jinengyaoqiu" placeholder="技能要求" clearable  :readonly="ro.jinengyaoqiu"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="技能要求" prop="jinengyaoqiu" >
					<el-input v-model="ruleForm.jinengyaoqiu" placeholder="技能要求" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="岗位薪资" prop="gangweixinzi" >
					<el-input-number v-model="ruleForm.gangweixinzi" placeholder="岗位薪资" :disabled="ro.gangweixinzi"></el-input-number>
				</el-form-item>
				<el-form-item v-else class="input" label="岗位薪资" prop="gangweixinzi" >
					<el-input v-model="ruleForm.gangweixinzi" placeholder="岗位薪资" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="应聘岗位" prop="zhaopingangwei" >
					<el-input v-model="ruleForm.zhaopingangwei" placeholder="应聘岗位" clearable  :readonly="ro.zhaopingangwei"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="应聘岗位" prop="zhaopingangwei" >
					<el-input v-model="ruleForm.zhaopingangwei" placeholder="应聘岗位" readonly></el-input>
				</el-form-item>
			...
			<el-form-item v-if="type!='info'"  label="投递详情" prop="toudixiangqing" >
				<editor 
					style="min-width: 200px; max-width: 600px;"
					v-model="ruleForm.toudixiangqing" 
					class="editor" 
					action="file/upload">
				</editor>
			</el-form-item>
			<el-form-item v-else-if="ruleForm.toudixiangqing" label="投递详情" prop="toudixiangqing" >
				<span class="text ql-snow ql-editor" v-html="ruleForm.toudixiangqing"></span>
			</el-form-item>
			...
			init(id,type) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					for (var o in obj){
						...
						if(o=='gangweixinzi'){
							this.ruleForm.gangweixinzi = obj[o];
							this.ro.gangweixinzi = true;
							continue;
						}
						if(o=='zhaopingangwei'){
						...
						if(o=='toudixiangqing'){
							this.ruleForm.toudixiangqing = obj[o];
							this.ro.toudixiangqing = true;
							continue;
						}
						if(o=='qiyezhanghao'){
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.toudixiangqing = this.ruleForm.toudixiangqing.replace(reg,'../../../GZIM_SYS/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
			...
			async onSubmit() {
					...
					await this.$refs["ruleForm"].validate(async valid => {
						if (valid) {
							...
							await this.$http({
								url: `toudijianli/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(async ({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.toudijianliCrossAddOrUpdateFlag = false;
											this.parent.search();
