		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="招聘岗位" prop="zhaopingangwei" >
					<el-input v-model="ruleForm.zhaopingangwei" placeholder="招聘岗位" clearable  :readonly="ro.zhaopingangwei"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="招聘岗位" prop="zhaopingangwei" >
				...
				<el-form-item class="date" v-if="type!='info'" label="招聘时间" prop="zhaopinshijian" >
					<el-date-picker
						format="yyyy 年 MM 月 dd 日"
						value-format="yyyy-MM-dd"
						v-model="ruleForm.zhaopinshijian" 
						type="date"
						:readonly="ro.zhaopinshijian"
						placeholder="招聘时间"
					></el-date-picker> 
				</el-form-item>
				<el-form-item class="input" v-else-if="ruleForm.zhaopinshijian" label="招聘时间" prop="zhaopinshijian" >
					<el-input v-model="ruleForm.zhaopinshijian" placeholder="招聘时间" readonly></el-input>
				</el-form-item>
			...
			<el-form-item v-else-if="ruleForm.zhaopinxiangqing" label="招聘详情" prop="zhaopinxiangqing" >
				<span class="text ql-snow ql-editor" v-html="ruleForm.zhaopinxiangqing"></span>
			</el-form-item>
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.zhaopinxiangqing = this.ruleForm.zhaopinxiangqing.replace(reg,'../../../GZIM_SYS/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
